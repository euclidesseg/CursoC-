namespace ClasesHerencia
{
    ...
    public class Mamiferos
    {
        ...
        // Cuando tenemos una clase en la cual no vemos un constreuctor implicitamente se toma el constructor por defecto como vacio 
        // asi mismo con las clases que hereden de esta clase es decir, el constructor de la subclase siempre llama al constructor de la clase padre
        // lo hacen con la instruccion :base()  cuando ninguna clase tiene 

        // Pero cuando creamos un objeto en la superclase construimos un constructor que recibe un parametro estamos obligado a llamar a ese constructor desde 
